...
public class Consumer_GuidedHelpSpec extends BaseUISpec {
    ...
    @Test(groups = {"regression"}, description = "Validate pharmacy pagination, map pin, tooltip")
    ...
    @Test(groups = {"regression"}, description = "Go to plans requires zip code")
    ...
    @Test(groups = {"regression"}, description = "User changes each section of guided help via edit button from PlanList")
