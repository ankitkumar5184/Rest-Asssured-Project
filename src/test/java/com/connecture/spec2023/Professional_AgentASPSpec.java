...
public class Professional_AgentASPSpec extends BaseUISpec {
    ...
    @Test( groups = { "regression" }, description = "Show permissioned plans for certain medicare states for medicare agent")
    ...
    @Test( groups = { "regression" }, description = "Show no medicare plans in certain states for medicare agent")
    ...
    @Test( groups = { "regression" }, description = "Show no medigap plans for medicare agent")
    ...
    @Test( groups = { "regression" }, description = "Show medigap plans for medigap agent")
    ...
    @Test( groups = { "regression" }, description = "Show no medicare plans for medigap agent")
