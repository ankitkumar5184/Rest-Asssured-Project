...
public class Consumer_ZipSpec extends BaseUISpec {
    ...
    @Test( groups = { "regression" }, description = "User validates zip code with multi state and multi county")
    public void zipCodeValidation() {
        ...
        @Test( groups = { "regression" }, description = "User validates zip code at  Home, Guided Help, Plan List, Helpful Tools")
    ...
    @Test( groups = { "regression" }, description = "Validate non-duplicate county names")
