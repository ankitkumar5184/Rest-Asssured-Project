...
public class Consumer_CartSpec extends BaseUISpec {
    ...
    @Test(groups = {"regression"}, description = "Validate premiums by adding multiple riders and minicart")
    ...
    @Test(groups = {"regression"}, description = "Validate rider combinations, add riders, replace and remove, also validate with show/hide")
    ...
    @Test(groups = {"regression"}, description = "Validate view rider details, change plan, remove plan")
    ...
    @Test(groups = {"regression"}, description = "Validate empty cart, zip change, add, replace plan")
